//
//  LandscapeQuestionsViewController.m
//  Quizilla
//
...
@interface LandscapeQuestionsViewController ()

@end

@implementation LandscapeQuestionsViewController
...
- (void)viewDidLoad {
    ...
    _btnQuestion.titleLabel.lineBreakMode = NSLineBreakByWordWrapping;
    // you probably want to center it
    _btnQuestion.titleLabel.textAlignment = NSTextAlignmentLeft; // if you want to
...
-(BOOL) shouldPerformSegueWithIdentifier:(NSString *)identifier sender:(id)sender
{
    ...
    if([identifier isEqualToString:@"showLandscapeReportCard"])
    {
...
{
    if([segue.identifier isEqualToString:@"showLandscapeReportCard"])
    {
...
{
    UIViewController *controller = [self.storyboard instantiateViewControllerWithIdentifier:@"LandscapeQuestionsTypeView"];
