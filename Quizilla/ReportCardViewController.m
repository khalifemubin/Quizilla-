...
-(void)willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    {
        LandscapeReportCardViewController *controller = [self.storyboard instantiateViewControllerWithIdentifier:@"LandScapeReportCardView"];

        /*[controller setQuestionType:_questionType];
        [controller setTotalQuestions:_totalQuestions];*/
